...
(function(){
    function angularTzExtensions(angular, timezoneJS, jstz){
        ...
        return angular.module('Timezones', [])
        ...
        .constant('$timezones.definitions.location', '/tz/data')

        .run(['$timezones.definitions.location',
            function (location) {
        ...
        .factory('$timezones',['$log', '$http', '$timezones.definitions.location', function ($log, $http, location) {
                    ...
                    if (localStorage.zones) {
                        ...
                        $http({ method: 'GET', url: location + '/zone.tab'})
                            .then(function(response) {
                                var i, fields, lines = response.data.match(/[^\r\n]+/g);
        ...
        .filter('tzAlign', ['$timezones', function ($timezones) {
    ...
    if (typeof module !== 'undefined' && module && module.exports) {
        ...
        angularTzExtensions(angular, timezoneJS, jstz);
        module.exports = 'Timezones';
    } else {
       angularTzExtensions(window.angular, window.timezoneJS, window.jstz);
    }
})();
